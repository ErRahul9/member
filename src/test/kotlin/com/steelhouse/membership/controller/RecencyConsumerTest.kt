...
//            "Any()", appConfig.recencyDeviceIDTTLSeconds.toString())).thenReturn(Any())
        ...
        val consumer = RecencyConsumer(log, meterRegistry, appConfig, util, redisConnectionRecency)
    ...
    fun storeVastImpressionRecencyMessage() {
        ...
        Mockito.verify(recencyAsyncCommands).evalsha<String>(appConfig.recencySha,
            ScriptOutputType.VALUE, array, "30619", "1667508238375",
            window.toString(), appConfig.recencyDeviceIDTTLSeconds.toString())
    ...
    fun storeGuidv2RecencyMessage() {
        ...
        val window = util.getEpochInMillis() - appConfig.recencyExpirationWindowMilliSeconds!!
        Mockito.verify(recencyAsyncCommands).evalsha<String>(appConfig.recencySha,
            ScriptOutputType.VALUE, array, "32794", "1667508514896",
            window.toString(), appConfig.recencyDeviceIDTTLSeconds.toString())
